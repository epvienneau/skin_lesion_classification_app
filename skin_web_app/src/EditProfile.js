	 ...
	 <Checkbox
	  ...
	  <RaisedButton
	    label="Create Profile"
            ...
            onClick={() => {{this.sendtodb({username:this.state.username, password:this.state.password,email:this.state.email,bday:this.state.birthday,phist:this.state.phistory,fhist:this.state.fhistory})}, {this.props.onScreenChange('homescreen')}}}
	  />
        </div>	
      </MuiThemeProvider>	
    );		
